...
class MySensor
{
  public:
	...
	* @param nanme identifdies the sensor with a name indicating to the user what type sensor it is
	*/
	void present(uint8_t sensorId, uint8_t sensorType, bool ack=false);
	void present(uint8_t sensorId, uint8_t sensorType, bool ack, const char * name);
